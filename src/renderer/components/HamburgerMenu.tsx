...
const HamburgerMenu: React.FC = () => {
  ...
  return (
    <>
      ...
      {/* Menu panel */}
      <div className="fixed left-0 top-0 bottom-0 w-72 bg-slate-900/95 backdrop-blur-xl border-r border-accent-subtle z-50 animate-slide-in overflow-y-auto" style={{ transform: 'translateX(0)' }}>
        {/* Header */}
